...
export class ProcessorService extends MapperService {
    ...
    private processCreateProcessor(): Observable<boolean> {
    ...
    createWorkerContractTerminationProcessor(option: Observable<TerminateWorkerContractOptions>): Subscription {
        return this.processCreateProcessor()
            .mergeMapTo(option)
            .subscribe(option => this.store.dispatch(new TerminateWorkerContractAction(option)));
    }
